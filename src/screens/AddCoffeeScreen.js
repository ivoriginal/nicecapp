      ...
      <>
        ...
        <View style={[styles.reviewModalContainer, { backgroundColor: theme.background }]}>
          ...
          <View style={styles.reviewModalContent}>
            <RecipeForm
              recipeData={recipeModalData}
              setRecipeData={setRecipeModalData}
              coffeeInfo={coffeeSuggestions[0]}
              showRemixAttribution={isRemixing || remixRecipe}
              remixRecipe={recipeToRemix || remixRecipe}
              scrollViewRef={recipeModalScrollRef}
